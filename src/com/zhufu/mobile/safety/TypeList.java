...
public class TypeList extends Activity {
	...
	public static void initValue() {
		...
		try {
			String callback = Mhttppost.post(Mstring.lab2, "love",
					Mstring.decrypetkey(), "type", "1", "text", text, "page",
					"" + pageNow);
	...
	public static void initValue2() {
		...
		try {
			String callback = Mhttppost.post(Mstring.lab2, "love",
					Mstring.decrypetkey(), "type", "2", "text", text, "page",
					"" + pageNow2);
			JSONArray arrayJson = new JSONArray(callback); // 得到json数据开始字符
			if (arrayJson.length() < 10) {
				isMore2 = false;
	...
	public static void initValue3() {
		...
		try {
			String callback = Mhttppost.post(Mstring.lab2, "love",
					Mstring.decrypetkey(), "type", "3", "text", text, "page",
					"" + pageNow3);
			JSONArray arrayJson = new JSONArray(callback); // 得到json数据开始字符
			if (arrayJson.length() < 10) {
				isMore3 = false;
