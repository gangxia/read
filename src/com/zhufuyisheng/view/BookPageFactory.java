...
public class BookPageFactory {
	...
	private String m_strCharsetName = null;
	...
	public BookPageFactory(int w, int h, String coding) {
		m_strCharsetName = coding;
		mWidth = w;
		mHeight = h;
	 ...
	 * @param strFilePath
	 * @param begin
	 *            ��ʾ��ǩ��¼��λ�ã���ȡ��ǩʱ����beginֵ��m_mbBufEnd���ڶ�ȡnextpage����
	 *            �ɹ���ȡ������ǩ ��¼ʱ��m_mbBufBegin��ʼλ����Ϊ��ǩ��¼
	 * 
	 * @throws IOException
	 */
