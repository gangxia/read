...
public class PageWidget extends View {
	...
	private int mScreenWidth = 480; // ��Ļ��
	private int mScreenHeight = 800; // ��Ļ��
	private int mCornerX = 1; // ��ק���Ӧ��ҳ��
	...
	int[] mBackShadowColors;// ������ɫ��
	int[] mFrontShadowColors;// ǰ����ɫ��
	GradientDrawable mBackShadowDrawableLR; // ����Ӱ��GradientDrawable
